...
app.use(cors({
  origin: 'http://16.112.63.255:5173', // your Vite frontend
  credentials: true
}));
...
app.listen(PORT, () => {
  console.log(`Server running on port ${PORT} - server.js:58`);
  console.log('Mongo URI: - server.js:59', process.env.MONGO_URI);
});
